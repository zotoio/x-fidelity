...
describe('Rule Validation', () => {
    ...
    describe('Complex Conditions', () => {
        it('should validate multiple conditions in all array', () => {
            const multiConditionRule: RuleConfig = {
                name: 'multiConditionRule',
                conditions: {
                    all: [
                ...
                event: { type: 'error', params: { message: 'Multiple conditions test' } }
            };

            expect(validateRule(multiConditionRule)).toBe(true);
        });

        it('should validate multiple conditions in any array', () => {
            const anyConditionRule: RuleConfig = {
                ...
                event: { type: 'warning', params: { message: 'Any conditions test' } }
            };

            expect(validateRule(anyConditionRule)).toBe(true);
        });
