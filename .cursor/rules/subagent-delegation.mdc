...
### Compress Cursor Rules
```
Task the crux-cursor-rule-manager subagent with:
"Compress this file into CRUX notation: [file path]
Load spec from CRUX.md. Target: <20% of original size while preserving all actionable information"
```
